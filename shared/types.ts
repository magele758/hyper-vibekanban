...
export type Workspace = { id: string, task_id: string | null, container_ref: string | null, branch: string, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, worktree_deleted: boolean, kind: WorkspaceKind, };

export type WorkspaceKind = "worktree" | "in_place" | "console";

export type WorkspaceWithStatus = { is_running: boolean, is_errored: boolean, id: string, task_id: string | null, container_ref: string | null, branch: string, setup_completed_at: string | null, created_at: string, updated_at: string, archived: boolean, pinned: boolean, name: string | null, worktree_deleted: boolean, kind: WorkspaceKind, };
 ...
 */
lite_mode: boolean, executors: { [key in BaseCodingAgent]?: ExecutorProfile }, };
...
export type AvailableCodingAgent = { executor: BaseCodingAgent, 
/**
 * True when an installation or login was detected locally.
 */
available: boolean, availability: AvailabilityInfo, };

export type ListAvailableAgentsResponse = { agents: Array<AvailableCodingAgent>, };
...
export type CreateWorkspaceApiRequest = { name: string | null, kind: WorkspaceKind, };
...
export enum BaseCodingAgent { CLAUDE_CODE = "CLAUDE_CODE", AMP = "AMP", GEMINI = "GEMINI", ANTIGRAVITY = "ANTIGRAVITY", CODEX = "CODEX", OPENCODE = "OPENCODE", CURSOR_AGENT = "CURSOR_AGENT", QWEN_CODE = "QWEN_CODE", COPILOT = "COPILOT", DROID = "DROID", PI = "PI", OH_MY_PI = "OH_MY_PI", GROK = "GROK" }

export type CodingAgent = { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "GEMINI": Gemini } | { "ANTIGRAVITY": Antigravity } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid } | { "PI": Pi } | { "OH_MY_PI": OhMyPi } | { "GROK": Grok };
...
export type ExecutorProfile = { recently_used_models?: ExecutorRecentModels | null, } & ({ [key in string]?: { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "GEMINI": Gemini } | { "ANTIGRAVITY": Antigravity } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid } | { "PI": Pi } | { "OH_MY_PI": OhMyPi } | { "GROK": Grok } });
...
export type Antigravity = { append_prompt: AppendPrompt, model?: string | null, dangerously_skip_permissions?: boolean | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
...
export type Pi = { append_prompt: AppendPrompt, model?: string | null, provider?: string | null, thinking?: PiThinking | null, 
/**
