...
use api_types::{
    Agent, AgentChatRuntime, AgentStatus, AgentTask, AgentTaskStatus, AgentTaskTrigger, Attachment,
    AttachmentUrlResponse, AttachmentWithBlob, Autopilot, AutopilotConcurrencyPolicy,
    AutopilotExecutionMode, AutopilotRun, AutopilotRunStatus, Blob, ClaimAgentTaskResponse,
    CopilotMessage, CopilotSession, CreateAgentRequest, CreateAgentTaskRequest,
    CreateAutopilotRequest, CreateCopilotMessageRequest, CreateCopilotSessionRequest,
    CreateFeishuBotBindingRequest, CreateIssueAssigneeRequest, CreateIssueCommentReactionRequest,
    ...
    ListSquadMembersResponse, ListSquadsResponse, ListWebhookEndpointsResponse, MemberRole,
    Notification, NotificationGroupKind, NotificationPayload, NotificationType, OrganizationMember,
    PipelineHumanGate, Project, ProjectStatus, PullRequest, PullRequestIssue, PullRequestStatus,
    RespondPipelineGateRequest, RespondPipelineGateResponse, RunSquadRequest, RunSquadResponse,
    SearchIssuesRequest, SortDirection, Squad, SquadLoopConfig, SquadMember, SquadNodePosition,
    SquadPipeline, SquadPipelineEdge, SquadPipelineEdgeBranch, SquadPipelineNode,
    SquadPipelineNodeType, SquadTargetType, Tag, UpdateAgentRequest, UpdateAgentTaskRequest,
    UpdateAutopilotRequest, UpdateFeishuBotBindingRequest, UpdateIssueCommentReactionRequest,
...
fn export_shapes() -> String {
    ...
    let type_decls = vec![
        ...
        PipelineHumanGate::decl(),
        RespondPipelineGateRequest::decl(),
        RespondPipelineGateResponse::decl(),
