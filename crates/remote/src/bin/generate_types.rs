...
use api_types::{
    Agent, AgentChatRuntime, AgentStatus, AgentTask, AgentTaskStatus, AgentTaskTrigger,
    ApproveSquadRunRequest, ApproveSquadRunResponse, Attachment, AttachmentUrlResponse,
    AttachmentWithBlob, Autopilot, AutopilotConcurrencyPolicy, AutopilotExecutionMode,
    AutopilotRun, AutopilotRunStatus, Blob, ClaimAgentTaskResponse, CopilotMessage, CopilotSession,
    CreateAgentRequest, CreateAgentTaskRequest, CreateAutopilotRequest,
    CreateCopilotMessageRequest, CreateCopilotSessionRequest, CreateFeishuBotBindingRequest,
    ...
    CreatePullRequestIssueRequest, CreateSquadRequest, CreateTagRequest,
    CreateWebhookEndpointRequest, ExportRequest, FeishuBotBinding, InboxItem,
    InboxUnreadCountResponse, Issue, IssueAssignee, IssueComment, IssueCommentReaction,
    IssueFollower, IssuePriority, IssueRelationship, IssueRelationshipType, IssueSortField,
    IssueTag, ListAgentTasksResponse, ListAgentsResponse, ListAutopilotResponse,
    ListAutopilotRunsResponse, ListCopilotMessagesResponse, ListCopilotSessionsResponse,
    ListFeishuBotBindingsResponse, ListInboxResponse, ListIssuesQuery, ListIssuesResponse,
    ListOrgAgentsResponse, ListSquadMembersResponse, ListSquadRunsResponse, ListSquadsResponse,
    ListWebhookEndpointsResponse, MemberRole, Notification, NotificationGroupKind,
    NotificationPayload, NotificationType, OrgAgentEntry, OrganizationMember, Project,
    ProjectStatus, PullRequest, PullRequestIssue, PullRequestStatus, RunSquadRequest,
    RunSquadResponse, SearchIssuesRequest, SortDirection, Squad, SquadLoopConfig, SquadMember,
    SquadNodePosition, SquadOnAssign, SquadPipeline, SquadPipelineEdge, SquadPipelineEdgeBranch,
    SquadPipelineNode, SquadPipelineNodeType, SquadRun, SquadRunStatus, SquadTargetType, Tag,
    UpdateAgentRequest, UpdateAgentTaskRequest, UpdateAutopilotRequest,
    UpdateFeishuBotBindingRequest, UpdateIssueCommentReactionRequest, UpdateIssueCommentRequest,
    UpdateIssueRequest, UpdateNotificationRequest, UpdateProjectRequest,
    UpdateProjectStatusRequest, UpdateSquadRequest, UpdateTagRequest, User, UserData,
    WebhookDelivery, WebhookEndpoint, Workspace,
};
...
fn export_shapes() -> String {
    ...
    let type_decls = vec![
        ...
        Agent::decl(),
        AgentStatus::decl(),
        AgentChatRuntime::decl(),
        AgentTask::decl(),
        AgentTaskStatus::decl(),
        AgentTaskTrigger::decl(),
        ClaimAgentTaskResponse::decl(),
        ListAgentsResponse::decl(),
        ListOrgAgentsResponse::decl(),
        OrgAgentEntry::decl(),
        ListAgentTasksResponse::decl(),
        Autopilot::decl(),
        AutopilotExecutionMode::decl(),
        AutopilotConcurrencyPolicy::decl(),
        AutopilotRun::decl(),
        AutopilotRunStatus::decl(),
        ListAutopilotResponse::decl(),
        ListAutopilotRunsResponse::decl(),
        Squad::decl(),
        SquadMember::decl(),
        SquadTargetType::decl(),
        SquadOnAssign::decl(),
        SquadPipeline::decl(),
        SquadPipelineNode::decl(),
        SquadPipelineNodeType::decl(),
        SquadPipelineEdge::decl(),
        SquadPipelineEdgeBranch::decl(),
        SquadNodePosition::decl(),
        SquadLoopConfig::decl(),
        ListSquadsResponse::decl(),
        ListSquadMembersResponse::decl(),
        RunSquadResponse::decl(),
        RunSquadRequest::decl(),
        SquadRun::decl(),
        SquadRunStatus::decl(),
        ApproveSquadRunRequest::decl(),
        ApproveSquadRunResponse::decl(),
        ListSquadRunsResponse::decl(),
        InboxItem::decl(),
        InboxUnreadCountResponse::decl(),
        ListInboxResponse::decl(),
        WebhookEndpoint::decl(),
        WebhookDelivery::decl(),
        ListWebhookEndpointsResponse::decl(),
        FeishuBotBinding::decl(),
        ListFeishuBotBindingsResponse::decl(),
        CopilotSession::decl(),
        CopilotMessage::decl(),
        ListCopilotSessionsResponse::decl(),
        ListCopilotMessagesResponse::decl(),
        Issue::decl(),
        IssueAssignee::decl(),
        Blob::decl(),
        Attachment::decl(),
        ...
        CreateAgentRequest::decl(),
        UpdateAgentRequest::decl(),
        CreateAgentTaskRequest::decl(),
        UpdateAgentTaskRequest::decl(),
        CreateAutopilotRequest::decl(),
        UpdateAutopilotRequest::decl(),
        CreateSquadRequest::decl(),
        UpdateSquadRequest::decl(),
        CreateWebhookEndpointRequest::decl(),
        CreateFeishuBotBindingRequest::decl(),
        UpdateFeishuBotBindingRequest::decl(),
        CreateCopilotSessionRequest::decl(),
        CreateCopilotMessageRequest::decl(),
