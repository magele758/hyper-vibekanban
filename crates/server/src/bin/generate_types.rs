...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::import::ImportWebExportResult::decl(),
        server::routes::import::ImportedProjectSummary::decl(),
        server::routes::import::ImportedProjectDetail::decl(),
        server::routes::import::CreateWorkspaceFromImportedTaskResponse::decl(),
        server::routes::projects::CreateProjectRequest::decl(),
        server::routes::projects::UpdateProjectRequest::decl(),
        server::routes::projects::AttachProjectRepoRequest::decl(),
        server::routes::projects::AttachProjectWorkspaceRequest::decl(),
        server::routes::projects::ProjectSummary::decl(),
        server::routes::projects::ProjectDetail::decl(),
        ...
        server::routes::config::AvailableCodingAgent::decl(),
        server::routes::config::ListAvailableAgentsResponse::decl(),
        ...
        server::routes::workspaces::workspace_summary::WorkspaceDiffStatsRequest::decl(),
        server::routes::workspaces::workspace_summary::WorkspaceDiffStatsEntry::decl(),
        server::routes::workspaces::workspace_summary::WorkspaceDiffStatsResponse::decl(),
        ...
        server::routes::trajectory::TokenUsageSummary::decl(),
        server::routes::trajectory::TrajectoryResponse::decl(),
