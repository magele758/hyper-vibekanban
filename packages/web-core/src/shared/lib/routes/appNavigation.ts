...
export interface AppNavigation {
  ...
  goToWorkforce(transition?: NavigationTransition): void;
  ...
  goToImported(transition?: NavigationTransition): void;
  goToProjectsOverview(transition?: NavigationTransition): void;
