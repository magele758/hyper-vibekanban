...
- Your self-hosted remote server (default local: `http://localhost:13000`)
- Your self-hosted relay server (default local: `http://localhost:18082`)
- The local desktop/API stack (default local: `http://localhost:13001` / `http://localhost:13002`)
