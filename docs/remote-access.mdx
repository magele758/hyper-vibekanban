...
On the client device where you'd now like to access your host machine from, open your **self-hosted remote-web** URL in a browser and log in (for local `vk-start`, typically `http://localhost:13000` or your Tailscale address).
